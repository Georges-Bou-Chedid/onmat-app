...
class _StudentSupportLegalPageState extends State<StudentSupportLegalPage> {
              ...
              child: Column(
                children: [
                  ...
                  _buildLegalTile(
                    ...
                    onTap: () {
                      // Logic to open website (e.g. url_launcher)
                    },
                  ),
  ...
  /// Reusable Tile Helper for Student Legal Items
  Widget _buildLegalTile({
    ...
    return ListTile(
      ...
      trailing: const Icon(Iconsax.export_1, size: 18, color: Colors.grey),
    );
  }
}